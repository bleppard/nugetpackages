Install-ChocolateyZipPackage 'php54' 'http://windows.php.net/downloads/releases/php-5.4.21-Win32-VC9-x86.zip' "$(Split-Path -parent $MyInvocation.MyCommand.Definition)"
