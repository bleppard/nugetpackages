Install-ChocolateyZipPackage 'php55' 'http://windows.php.net/downloads/releases/php-5.5.6-Win32-VC11-x86.zip' "$(Split-Path -parent $MyInvocation.MyCommand.Definition)"
